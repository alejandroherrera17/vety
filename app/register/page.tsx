      ...
      <section className="relative mx-auto grid min-h-screen w-full max-w-7xl grid-cols-1 lg:grid-cols-[1.08fr_0.92fr]">
        <aside className="relative hidden min-h-screen flex-col justify-between border-r border-white/10 px-10 py-9 lg:flex">
          ...
          <div className="relative mb-4 mt-12">
            <div className="absolute -left-8 -top-8 h-40 w-40 rounded-full bg-cyan-400/10 blur-3xl" />
            ...
            <div className="relative rounded-lg border border-white/12 bg-white/[0.07] p-4 shadow-2xl shadow-black/40 backdrop-blur-2xl">
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                {metrics.map((metric) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className="mb-5 h-4 w-4 text-cyan-200" />
              ...
              <div className="mt-3 grid grid-cols-[1fr_0.8fr] gap-3">
                <div className="rounded-lg border border-white/10 bg-[#06111f]/80 p-4">
                  ...
                  <div className="flex h-28 items-end gap-2">
                    {[48, 72, 44, 86, 62, 95, 76, 88].map((height, index) => (
                      <div
                        key={index}
                        className="w-full rounded-t bg-gradient-to-t from-cyan-400/30 to-emerald-200"
                        style={{ height: `${height}%` }}
                      />
                    ))}
                  </div>
                ...
                <div className="rounded-lg border border-white/10 bg-[#06111f]/80 p-4">
                  <p className="text-sm font-semibold">Temas enterprise</p>
            ...
            <div className="absolute -right-5 -top-5 w-56 rounded-lg border border-cyan-200/20 bg-[#071321]/90 p-4 shadow-2xl shadow-cyan-950/40 backdrop-blur-xl">
              <div className="flex items-start gap-3">
                <div className="grid h-9 w-9 place-items-center rounded-lg bg-cyan-300/12 text-cyan-100">
