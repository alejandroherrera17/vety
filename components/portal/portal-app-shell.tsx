...
export function PortalAppShell({
  ...
  return (
    <div className="h-full" data-theme="emerald_care">
          ...
          <div className="fixed inset-0 flex">
            <div className="relative mr-16 flex w-full max-w-xs flex-1 flex-col bg-surface border-r border-border">
              ...
              <div className="flex h-16 shrink-0 items-center px-6 border-b border-border gap-3">
                ...
                <span className="text-xl font-bold tracking-tight text-white">Vety Portal</span>
              </div>
                    ...
                    return (
                      <Link
                        ...
                        className={classNames(
                          isActive ? "bg-primary/10 text-primary" : "text-muted hover:bg-surface-hover hover:text-white",
      ...
      <div className="flex flex-1 flex-col lg:pl-64 h-full bg-background">
        <div className="sticky top-0 z-10 bg-surface/80 backdrop-blur-md border-b border-border pl-1 pt-1 sm:pl-3 sm:pt-3 lg:hidden">
          <button
            type="button"
            className="-ml-0.5 -mt-0.5 inline-flex h-12 w-12 items-center justify-center rounded-md text-slate-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary"
